...
def main():
    ...
    points = [(categories[category_name]["codelength"], loss) for category_name in categories for loss in learning_data[category_name]]
    ...
    plot = (
        ...
        + pn.geom_point(size=2, shape="+", data=df,)
